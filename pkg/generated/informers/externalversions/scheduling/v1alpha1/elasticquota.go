...
import (
	...
	schedulingv1alpha1 "sigs.k8s.io/k8s-scheduler-self/apis/scheduling/v1alpha1"
	versioned "sigs.k8s.io/k8s-scheduler-self/pkg/generated/clientset/versioned"
	internalinterfaces "sigs.k8s.io/k8s-scheduler-self/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "sigs.k8s.io/k8s-scheduler-self/pkg/generated/listers/scheduling/v1alpha1"
)
