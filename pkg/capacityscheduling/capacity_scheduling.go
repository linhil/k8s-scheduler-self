...
import (
	...
	"sigs.k8s.io/k8s-scheduler-self/apis/scheduling"
	"sigs.k8s.io/k8s-scheduler-self/apis/scheduling/v1alpha1"
	"sigs.k8s.io/k8s-scheduler-self/pkg/generated/clientset/versioned"
	schedinformer "sigs.k8s.io/k8s-scheduler-self/pkg/generated/informers/externalversions"
	externalv1alpha1 "sigs.k8s.io/k8s-scheduler-self/pkg/generated/listers/scheduling/v1alpha1"
	"sigs.k8s.io/k8s-scheduler-self/pkg/util"
)
