...
import (
	...
	config "sigs.k8s.io/k8s-scheduler-self/apis/config"
)
...
func autoConvert_v1beta2_NodeResourceTopologyMatchArgs_To_config_NodeResourceTopologyMatchArgs(in *NodeResourceTopologyMatchArgs, out *config.NodeResourceTopologyMatchArgs, s conversion.Scope) error {
	// WARNING: in.ScoringStrategy requires manual conversion: inconvertible types (*sigs.k8s.io/k8s-scheduler-self/apis/config/v1beta2.ScoringStrategy vs sigs.k8s.io/k8s-scheduler-self/apis/config.ScoringStrategy)
...
func autoConvert_config_NodeResourceTopologyMatchArgs_To_v1beta2_NodeResourceTopologyMatchArgs(in *config.NodeResourceTopologyMatchArgs, out *NodeResourceTopologyMatchArgs, s conversion.Scope) error {
	// WARNING: in.ScoringStrategy requires manual conversion: inconvertible types (sigs.k8s.io/k8s-scheduler-self/apis/config.ScoringStrategy vs *sigs.k8s.io/k8s-scheduler-self/apis/config/v1beta2.ScoringStrategy)
