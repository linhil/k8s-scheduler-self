...
import (
	...
	"sigs.k8s.io/k8s-scheduler-self/apis/config"
	"sigs.k8s.io/k8s-scheduler-self/apis/config/v1"
	"sigs.k8s.io/k8s-scheduler-self/apis/config/v1beta2"
	"sigs.k8s.io/k8s-scheduler-self/apis/config/v1beta3"
